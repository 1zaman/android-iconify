...
public enum MaterialIcons implements Icon {
    md_3d_rotation('\ue84d', false),
    md_access_alarm('\ue190', false),
    md_access_alarms('\ue191', false),
    md_access_time('\ue192', false),
    md_accessibility('\ue84e'),
    md_account_balance('\ue84f'),
    md_account_balance_wallet('\ue850', false),
    md_account_box('\ue851'),
    md_account_circle('\ue853'),
    md_adb('\ue60e', false),
    md_add('\ue145'),
    ...
    md_assignment_turned_in('\ue862', false),
    md_assistant('\ue39f'),
    md_assistant_photo('\ue3a0'),
    md_attach_file('\ue226'),
    md_attach_money('\ue227', false),
    md_attachment('\ue2bc'),
    md_audiotrack('\ue3a1', false),
    md_autorenew('\ue863'),
    md_av_timer('\ue01b', false),
    ...
    md_block('\ue14b'),
    md_bluetooth('\ue1a7', false),
    md_bluetooth_audio('\ue60f', false),
    md_bluetooth_connected('\ue1a8', false),
    md_bluetooth_disabled('\ue1a9', false),
    md_bluetooth_searching('\ue1aa', false),
    md_blur_circular('\ue3a2'),
    md_blur_linear('\ue3a3'),
    md_blur_off('\ue3a4'),
    md_blur_on('\ue3a5'),
    ...
    md_border_bottom('\ue229'),
    md_border_clear('\ue22a'),
    md_border_color('\ue22b', false),
    md_border_horizontal('\ue22c'),
    md_border_inner('\ue22d'),
    md_border_left('\ue22e', false),
    md_border_outer('\ue22f'),
    md_border_right('\ue230', false),
    md_border_style('\ue231'),
    md_border_top('\ue232'),
    md_border_vertical('\ue233'),
    md_brightness_1('\ue3a6'),
    ...
    md_check('\ue5ca', false),
    md_check_box('\ue834', false),
    md_check_box_outline_blank('\ue835', false),
    md_check_circle('\ue86c', false),
    md_chevron_left('\ue5cb'),
    md_chevron_right('\ue5cc'),
    ...
    md_explore('\ue87a'),
    md_exposure('\ue3ca', false),
    md_exposure_neg_1('\ue3cb', false),
    md_exposure_neg_2('\ue3cc', false),
    md_exposure_plus_1('\ue3cd', false),
    md_exposure_plus_2('\ue3ce', false),
    md_exposure_zero('\ue3cf', false),
    md_extension('\ue87b'),
    md_face('\ue87c'),
    md_fast_forward('\ue01f', false),
    md_fast_rewind('\ue020', false),
    md_favorite('\ue87d'),
    md_favorite_border('\ue87e'),
    md_feedback('\ue87f'),
    md_file_download('\ue2c4'),
    ...
    md_filter_vintage('\ue3e3'),
    md_find_in_page('\ue880', false),
    md_find_replace('\ue881', false),
    md_flag('\ue153'),
    md_flare('\ue3e4'),
    md_flash_auto('\ue3e5'),
    md_flash_off('\ue3e6'),
    ...
    md_folder_shared('\ue2c9'),
    md_folder_special('\ue617'),
    md_font_download('\ue167', false),
    md_format_align_center('\ue234', false),
    md_format_align_justify('\ue235', false),
    md_format_align_left('\ue236', false),
    md_format_align_right('\ue237', false),
    md_format_bold('\ue238', false),
    md_format_clear('\ue239'),
    md_format_color_fill('\ue23a'),
    md_format_color_reset('\ue23b'),
    md_format_color_text('\ue23c', false),
    md_format_indent_decrease('\ue23d'),
    md_format_indent_increase('\ue23e'),
    md_format_italic('\ue23f', false),
    md_format_line_spacing('\ue240'),
    md_format_list_bulleted('\ue241'),
    md_format_list_numbered('\ue242', false),
    md_format_paint('\ue243'),
    md_format_quote('\ue244'),
    md_format_size('\ue245', false),
    md_format_strikethrough('\ue246'),
    md_format_textdirection_l_to_r('\ue247', false),
    md_format_textdirection_r_to_l('\ue248', false),
    ...
    md_keyboard_arrow_left('\ue314', false),
    md_keyboard_arrow_right('\ue315', false),
    ...
    md_local_cafe('\ue541', false),
    md_local_car_wash('\ue542'),
    md_local_convenience_store('\ue543', false),
    md_local_dining('\ue556', false),
    md_local_drink('\ue544'),
    md_local_florist('\ue545'),
    md_local_gas_station('\ue546', false),
    ...
    md_local_movies('\ue54d'),
    md_local_offer('\ue54e'),
    md_local_parking('\ue54f', false),
    md_local_pharmacy('\ue550', false),
    md_local_phone('\ue551'),
    md_local_pizza('\ue552'),
    md_local_play('\ue553'),
    md_local_post_office('\ue554'),
    md_local_printshop('\ue555', false),
    md_local_see('\ue557'),
    md_local_shipping('\ue558'),
    md_local_taxi('\ue559'),
    md_location_city('\ue7f1'),
    ...
    md_notifications_paused('\ue7f8', false),
    md_offline_pin('\ue90a', false),
    md_ondemand_video('\ue63a', false),
    md_open_in_browser('\ue89d'),
    md_open_in_new('\ue89e'),
    md_open_with('\ue89f'),
    md_pages('\ue7f9'),
    ...
    md_perm_device_information('\ue8a5', false),
    md_perm_identity('\ue8a6'),
    md_perm_media('\ue8a7'),
    md_perm_phone_msg('\ue8a8'),
    md_perm_scan_wifi('\ue8a9'),
    ...
    md_phone('\ue0cd'),
    md_phone_android('\ue324'),
    md_phone_bluetooth_speaker('\ue61b', false),
    md_phone_forwarded('\ue61c'),
    md_phone_in_talk('\ue61d'),
    md_phone_iphone('\ue325'),
    md_phone_locked('\ue61e'),
    ...
    md_picture_as_pdf('\ue415', false),
    md_picture_in_picture('\ue8aa'),
    md_pin_drop('\ue55e'),
    md_place('\ue55f'),
    md_play_arrow('\ue037', false),
    md_play_circle_filled('\ue038', false),
    md_play_circle_outline('\ue039', false),
    md_play_for_work('\ue906'),
    md_playlist_add('\ue03b'),
    md_plus_one('\ue800', false),
    md_poll('\ue801'),
    ...
    md_public('\ue80b', false),
    md_publish('\ue255'),
    md_query_builder('\ue8ae', false),
    md_question_answer('\ue8af'),
    md_queue('\ue03c'),
    md_queue_music('\ue03d', false),
    md_radio('\ue03e', false),
    md_radio_button_checked('\ue837'),
    md_radio_button_unchecked('\ue836'),
    md_rate_review('\ue560', false),
    md_receipt('\ue8b0'),
    md_recent_actors('\ue03f'),
    md_redeem('\ue8b1'),
    md_redo('\ue15a'),
    ...
    md_report('\ue160'),
    md_report_problem('\ue8b2'),
    md_restaurant_menu('\ue561', false),
    md_restore('\ue8b3', false),
    md_ring_volume('\ue0d1'),
    md_room('\ue8b4'),
    md_rotate_90_degrees_ccw('\ue418', false),
    md_rotate_left('\ue419', false),
    md_rotate_right('\ue41a', false),
    md_router('\ue328'),
    md_satellite('\ue562'),
    md_save('\ue161'),
    md_scanner('\ue329'),
    ...
    md_signal_cellular_no_sim('\ue1ce', false),
    ...
    md_signal_wifi_off('\ue1da'),
    md_sim_card('\ue32b', false),
    md_sim_card_alert('\ue624', false),
    md_skip_next('\ue044', false),
    md_skip_previous('\ue045', false),
    md_slideshow('\ue41b', false),
    md_smartphone('\ue32c'),
    md_sms('\ue625'),
    md_sms_failed('\ue626'),
    ...
    MaterialIcons(char character, boolean supportsRtl) {
